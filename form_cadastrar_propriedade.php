...
<body>
 ...
 <div class="divao">              
        ...
        <div class="div-sec">                 
                ...
                <form action="inserir_propriedade.php" method="POST" class="form" enctype="multipart/form-data"  onsubmit="return validarFormulario()">
                <hr style="margin-bottom: 1rem;">
<h1>Cadastrar Propriedade</h1>
<hr style="margin-bottom: 1rem;">
<h2>Adicione até 3 imagens:</h2>
<div class="div-org">
...
<div class="div-img">
    ...
    <div class="container-caixa">
        ...
        <img id="imagem" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSY_F8KPZ9MJqWbREUegZRkD8iHfyzJuOLJ6w&s" alt="Imagem padrão">
        
        <!-- Texto sobre a imagem -->
        <div class="input-label"><h3 class="h3-i">*Imagem Principal</h3></div>

        <!-- Input do tipo file que será invisível mas clicável -->
...
<div class="div-img-2">
    <div class="container-caixa">
        <!-- Imagem que será alterada -->
        <img id="imagem-2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSY_F8KPZ9MJqWbREUegZRkD8iHfyzJuOLJ6w&s" alt="Imagem padrão">
        
        <!-- Texto sobre a imagem -->
        <div class="input-label-2">Adcionar Imagem</div>
...
<div class="div-img-3">
    <div class="container-caixa">
        <!-- Imagem que será alterada -->
        <img id="imagem-3" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSY_F8KPZ9MJqWbREUegZRkD8iHfyzJuOLJ6w&s" alt="Imagem padrão">
        
        <!-- Texto sobre a imagem -->
        <div class="input-label-3">Adcionar Imagem</div>
        ...
        <button type="button" id="excluir-imagem-3" style="display: none;">Excluir</button>
                    ...
                    <i class="fa fa-pencil-square-o" id="fa-2" style='font-size:17px; color: #7f8c8d;'>&#xf303;</i>

                        <input type="text" name="titulo"  id="inputTitulo" placeholder="Título" required autofocus>
                    </label>

                    <label class="label-input" for="">
  <i class='fas fa-pencil-ruler' style='font-size:17px; color: #7f8c8d;'></i>
  <input type="text" name="tamanho" placeholder="Tamanho (m²)" required autofocus id="inputTamanho" oninput="formatNumber(this)">
</label>

<label class="label-input" for="">
<i class="fa fa-leaf" style='font-size:17px; color: #7f8c8d;'></i>

<select name="tipo_solo" id="select" required autofocus>
  <option value="" selected>Selecione um tipo de solo</option>
  <option value="Pedregoso">Pedregoso</option>
  <option value="Arenoso">Arenoso</option>
  <option value="Argiloso">Argiloso</option>
  <option value="Latosolo(Terra Roxa)">Latosolo(Terra Roxa)</option>
</select>
          </label>
            ...
            <div class="form-2" >
            <hr style="margin-bottom: 1rem;">
            <h2>Insira no mapa a localização de sua  propriedade</h2>
            <hr style="margin-bottom: 1rem;">
            <div id="map">
...
<div class="div-lado-imagem">
   ...
   <h3>Coordenadas:</h3>
       ...
       <input type="text" name="coordenadas" id="input-coordenadas" required readonly>
   </div>
   <div class="div-estado">
   <h3>Estado:</h3>
       <span id="i-estado" class="fas fa-map" style='font-size:17px; color: #7f8c8d;'></span>
       <input type="text" name="estado" id="input-estado" required readonly>
   </div>
   <div class="div-cidade">
   <h3>Cidade:</h3>
       <i class='fas' style='font-size:17px; color: #7f8c8d;'>&#xf64f;</i>
       <input type="text" name="cidade" id="input-cidade" required readonly>
   </div>
         ...
         if (isset($_SESSION["result"])) {
            ...
            if ($_SESSION["result"]) {
              ...
              <script>
                ...
                balao.innerHTML = 'Propriedade Cadastrada';
              ...
              <script>
                const balao = document.createElement('div');
                balao.classList.add('balao');
                balao.innerHTML = 'Falha ao cadastrar: <?= $erro ?>';
                document.body.appendChild(balao);
...
document.getElementById('excluir-imagem-1').addEventListener('click', function() {
    document.getElementById('imagem').src = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSY_F8KPZ9MJqWbREUegZRkD8iHfyzJuOLJ6w&s';
    document.getElementById('excluir-imagem-1').style.display = 'none';
    document.getElementById('imageFile').value = ''; // Atualize o valor do campo de imagem para uma string vazia
});

document.getElementById('excluir-imagem-2').addEventListener('click', function() {
    document.getElementById('imagem-2').src = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSY_F8KPZ9MJqWbREUegZRkD8iHfyzJuOLJ6w&s';
    document.getElementById('excluir-imagem-2').style.display = 'none';
    document.getElementById('imageFile-2').value = ''; // Atualize o valor do campo de imagem para uma string vazia
});

document.getElementById('excluir-imagem-3').addEventListener('click', function() {
    document.getElementById('imagem-3').src = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSY_F8KPZ9MJqWbREUegZRkD8iHfyzJuOLJ6w&s';
    document.getElementById('excluir-imagem-3').style.display = 'none';
    document.getElementById('imageFile-3').value = ''; // Atualize o valor do campo de imagem para uma string vazia
});

// Verifique se o campo de imagem está vazio antes de enviar o formulário
document.querySelector('form').addEventListener('submit', function(event) {
    if (document.getElementById('imageFile').value == '' && document.getElementById('imageFile-2').value == '' && document.getElementById('imageFile-3').value == '') {
  ...
  function validarFormulario() {
    // Verificar campos obrigatórios de cidade, coordenadas e estado
    var coordenadas = document.getElementById('input-coordenadas').value;
    var estado = document.getElementById('input-estado').value;
    var cidade = document.getElementById('input-cidade').value;

    if (coordenadas === '' || estado === '' || cidade === '') {
        alert('Por favor, preencha todos os campos obrigatórios de localização.');
        return false;
    }

    // Verificar campos de texto obrigatórios (mesmo se 'required' foi removido)
    var titulo = document.getElementById('inputTitulo').value;
    var tamanho = document.getElementById('inputTamanho').value;
    var tipoSolo = document.getElementById('select').value;
    ...
    // O formulário será enviado se todos os campos estiverem preenchidos
    return true;
}
...
// Cria a instância do mapa com estilo satélite e etiquetas, centralizado no Brasil
...
const locateControl = new mapboxgl.GeolocateControl({
    ...
    fitBoundsOptions: {
        maxZoom: 12 // Ajusta o nível de zoom ao aproximar o usuário
    }
});

// Adiciona o controle de localização ao mapa
...
locateControl.on('geolocate', function (e) {
    ...
    // Atualiza as coordenadas após adicionar o marcador
    document.querySelector('.div-coordenadas .t-div').textContent = `${e.coords.latitude.toFixed(6)}, ${e.coords.longitude.toFixed(6)}`;
...
// Função para buscar cidade e estado usando a API de geocodificação reversa do Mapbox
function reverseGeocode(lng, lat) {
    var url = `https://api.mapbox.com/geocoding/v5/mapbox.places/${lng},${lat}.json?access_token=${mapboxgl.accessToken}&types=place,region`;
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            if (data && data.features && data.features.length > 0) {
                let place = data.features.find(feature => feature.place_type.includes('place'));
                ...
                if (place) {
                    document.getElementById('input-cidade').value = place.text;
                }
                if (region) {
...
document.querySelector('form').addEventListener('submit', function(e) {
        ...
        const coordenadas = document.getElementById('input-coordenadas').value.trim();
        const cidade = document.getElementById('input-cidade').value.trim();
        const estado = document.getElementById('input-estado').value.trim();

        // Se algum dos campos estiver vazio, exibe um alerta e impede o envio do formulário
