...
<body>
    <div class="container">
        ...
        <div class="content first-content">
            ...
            <div id="in-div">
                ...
                <h2 class="title title-primary"><i id="link-v" class='far fa-arrow-alt-circle-left' style="font: size 23px;" onclick="window.location.href='index.php'"></i>Cadastrar</h2>
                ...
                <a href="form_login_empresa.php"><button class="btn btn-primary">Entrar</button></a>
 ...
 <div class="divao">              
        ...
        <div class="div-sec">                 
      <h2 class="title title-second">Criar Conta - Empresa</h2>
    
        <form action="inserir_empresa.php" method="POST" class="form"  onsubmit="return validarFormulario()">
...
<label class="label-input" for="">
                        ...
                        <input type="text" id="nome_emp" name="nome_emp" class="form-control" placeholder="Nome" required autofocus>
                    </label>

                    <label class="label-input" for="">
                    <i class="fa fa-phone" style="color: #7f8c8d; margin: 0.3vw;"></i>
                    <input type="text" id="telefone_emp" name="telefone_emp" placeholder="Telefone" required autofocus>
                    </label>

                    <label class="label-input" for="">
                    <i class='fas fa-building' style="color: #7f8c8d; margin: 0.3vw;"></i>
                    <input type="text" id="cnpj" name="cnpj" placeholder="CNPJ" required autofocus>
                    </label>
                    
                    <label class="label-input" for="">
                        <i class="far fa-envelope icon-modify"></i>
                        <input type="email" id="email_emp" name="email_emp" placeholder="Email" required autofocus>
                    </label>
                    
                    <label class="label-input" for="">
                        <i class="fas fa-lock icon-modify"></i>
                        <input type="password" id="senha_emp" name="senha_emp" placeholder="Senha" required autofocus>
                    </label>
                   ...
                   <button class="btn btn-second" type="submit" id="submit-btn">Cadastrar</button>       
                </form>
                <?php   
...
<a href="form_login_empresa.php">Acessar Conta</a>
</div>
<?php
}else{
$erro = $_SESSION["erro"];
...
// Função para validar as senhas no momento da digitação
document.getElementById('senha_emp').addEventListener('input', function() {
