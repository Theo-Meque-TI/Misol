...
<body>
    <div class="container">
        ...
        <div class="content first-content">
            ...
            <div id="in-div">
                ...
                <h2 class="title title-primary"><i id="link-v" class='far fa-arrow-alt-circle-left' style='font: size 28px;px;' onclick="window.location.href='form_cadastrar_empresa.php'"></i>Acessar Conta</h2>
                ...
                <a href="form_cadastrar_empresa.php"><button class="btn btn-primary">Cadastrar</button></a>
 ...
 <div class="divao">              
        ...
        <form action="login_empresa.php" method="POST" class="form">

        <h2 class="title title-second">Entrar - Empresa</h2>
